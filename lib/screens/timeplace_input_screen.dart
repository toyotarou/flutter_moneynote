    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Container(
            padding: EdgeInsets.only(right: 20, left: 20, bottom: bottomSpace),
            child: Column(
              children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          onPressed: () async {
                            await _ref
                                .read(timeplaceInputProvider(diff).notifier)
                          ...
                          icon:
                              const Icon(Icons.input, color: Colors.pinkAccent),
                        ),
            ...
            children: [
              SizedBox(
                ...
                child: TextField(
                  ...
                  readOnly: true,
                  controller:
                      TextEditingController(text: timeplaceInputState.time[i]),
